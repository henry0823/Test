	   	...
	   	<div class="row">
	   		<div class="col-md-8 col-md-offset-2">
	   			<div class="jumbotron" style="background-color: #BCE">
		   			{{ Form::open(array('action' => array('Guest\CommentController@reply_store', $user->name, $comment->id), 'method' => 'post')) }}
					...
					<hr>
		   			...
		   			<a href="/{{ $user->name }}/comment/" class="btn btn-xs btn-default">
		   			上一頁</a>
